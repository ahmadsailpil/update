...
capuser[m.sender.split('@')[0]] = { user: sender, jawaban: jawaban.toLowerCase()}  
  fs.writeFileSync("./worker/src/captcha/capuser.json", JSON.stringify(capuser))
        ...
        sock.sendMessage(
         ...
         footer: 'FAXTBOTZ ~ RIDHO', mentions: [sender] 
         })
...
"title": "FAXTBOTZ ~ RIDHO", //Kasih namalu 
"description": "SELF BOT", 
"currencyCode": "USD",
"priceAmount1000": "2000",
"retailerId": "FAXTBOTZ ~ RIDHO",
"productImageCount": 1
},
...
status: 1,
surface : 1,
message: 'FAXTBOTZ ~ RIDHO', //Kasih namalu
orderTitle: 'Bang',
...
if (isBan) return ads(mess.ban)
if (args.length < 1) return ads(`Example:\n${prefix}fliptext FAXTBOTZ ~ RIDHO`)
quere = args.join(" ")
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© FAXTBOTZ ~ RIDHO", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© FAXTBOTZ ~ RIDHO", log0, btn, thum)
}
